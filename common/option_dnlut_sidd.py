...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--sigma', '-s', type=int, default=0, help="noise level")
        ...
        parser.add_argument('--stages', type=int, default=5, help="stages of MuLUT")
        parser.add_argument('--modes', type=str, default='v', help="sampling modes to use in every stage")
        ...
        parser.add_argument('--expDir', '-e', type=str, default='/home/styan/DNLUT/exp/DnLUT_reproduce_sidd', help="experiment folder")
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--trainDir', type=str, default="/home/styan/resource_dir/Denoise/Datasets/SIDD_train")
        parser.add_argument('--valDir', type=str, default='/home/styan/resource_dir/Denoise/Datasets/SIDD/val')
...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--testDir', type=str, default='../data/DNBenchmark')
