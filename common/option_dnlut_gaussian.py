...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--expDir', '-e', type=str, default='/home/styan/DnLUT/exp/DnLUT_reproduce_guassion', help="experiment folder")
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--trainDir', type=str, default="/home/styan/resource_dir/Denoise/Datasets/train/DFWB")
        parser.add_argument('--valDir', type=str, default='/home/styan/resource_dir/Denoise/Datasets/test')
