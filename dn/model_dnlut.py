...
mode_pad_dict = {"s": 1, "d": 2, "y": 2, "e": 3, "h": 3, "o": 3, "m": 1}
...
if __name__ == '__main__':
    ...
    def mulut_predict(model_G, x, phase="train"):
        modes, stages = ['s', 'd', 'y'], 2
        pred = 0
        for r in [0, 1, 2, 3]:
    ...
    model = SRNets(64, 1, ['m', 's', 'd', 'y'], 2)
    out = mulut_predict(model, inp)
    print(out.shape)
