...
import model
from data import ProviderDN, DNBenchmark
...
def valid_steps(model_G, valid, opt, iter):
    if opt.debug:
        datasets = ['CBSD68', 'Set12']
    else:
        datasets = ['CBSD68', 'Kodak', 'Set12']
...
if __name__ == "__main__":
    ...
    # Training dataset
    train_iter = ProviderDN(opt.batchSize, opt.workerNum, opt.scale, opt.trainDir, opt.cropSize, opt.sigma)
